...
from utils.my_logging import log
from utils.my_multiprocessing import the_parallel_executor, split_by_batch_size, split_into_parts
from probability.binomial_cdf import lcb, ucb
...
class EpsEstimator:
    ...
    def compute_eps_estimate(self, a1, a2, attack: Attack) -> (float, float):
        ...
        #     pr_list.append(self.pr_estimator.compute_pr_estimate(a1, attack))
        #
        # var = np.var(pr_list)
        # print("variance: ",var)
        #
